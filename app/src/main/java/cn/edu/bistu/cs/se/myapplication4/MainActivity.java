package cn.edu.bistu.cs.se.myapplication4;
               ...
               InputStream in = null;
                try{
                    ...
                    try{
                        ...
                        Toast.makeText(MainActivity.this,"姓名：徐子昂 " + " 学号：" + stringBuilder.toString(),Toast.LENGTH_LONG).show();
                    }
                    finally {
                        if(in != null)
                            in.close();
